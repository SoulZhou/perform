...
//        	centerDrawable = getContext().getResources().getDrawable(R.drawable.wheel_center_bk);
        }  
...
//        setBackgroundResource(R.drawable.wheel_bg); 
     ...
     * 获取条目的最大长度. 用来定义 WheelView 的宽度. 如果返回 0, 就会使用默认宽度
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {  
        ...
        JPrintBug.getPrint().d("wheel", "width =="+width+"   height == "+height);
